    ...
    <section id="admin-dashboard">
        ...
        <div class="info">
            ...
            <div class="filtros-rapidos">
                ...
                <a href="<?= BASE_URL ?>/administrador/reporte?tipo=proveedor_hotelero"
                        ...
                        <tr>
                            <?php if (!empty($datos)) : ?>
                                <?php foreach ($datos as $hotelero): ?>
                                    <td><img src="<?= BASE_URL ?>/public/uploads/hoteles/<?= $hotelero['foto'] ?>" alt="Logo Empresa" class="logo-empresa">
