            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="editar">
                        ...
                        <form action="">
                            <h4>Nombre Completo</h4>
                            <input type="text" placeholder="carlos perez">

                            <h4>Correo Electrónico</h4>
                            <input type="text" placeholder="alguien@mail.com">

                            <h4>Teléfono</h4>
                            <input type="number" placeholder="+57 3001234567">

                            <h4>Dirección</h4>
                            <input type="text" placeholder="carrera 10 # 20-30">

                            <h4>Identificacion</h4>
                            <input type="text" placeholder="1021667223">
